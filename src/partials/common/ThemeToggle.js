      ...
      <Switch.Group>
        <div className='flex items-start justify-between mt-3'>
          <Switch.Label className='mr-4'>
            <div className='text-sm font-medium leading-6'>Switch theme</div>
            <p className='text-xs font-medium leading-6 text-gray-700 dark:text-gray-300'>Need a light or dark theme?</p>
          </Switch.Label>
          <Switch
            checked={enabled}
            onChange={() => changeCurrentTheme(enabled ? 'light' : 'dark')}
            className={`${
